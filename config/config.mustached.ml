...
*)
let bytecomp_c_compiler = {|gcc -O2 -fno-strict-aliasing -fwrapv -pthread    -D_FILE_OFFSET_BITS=64 |}
let native_c_compiler = {|gcc @ocamlopt_cflags@ @ocamlopt_cppflags@|}

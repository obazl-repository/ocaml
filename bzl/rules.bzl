...
load("//bzl/rules:kick_executable.bzl",
     _kick_executable = "kick_executable")
...
load("//bzl/rules:kick_compiler.bzl", _kick_compiler = "kick_compiler")

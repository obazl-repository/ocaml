...
CAMLprim int64_t caml_int64_{{prim}}_native(int64_t i1, int64_t i2)
{ return i1 + i2; }
CAMLprim value caml_int64_{{prim}}(value v1, value v2)
{ return caml_copy_int64(caml_int64_{{prim}}_native(Int64_val(v1),
                                                    Int64_val(v2))); }
{{/prim=add}}
{{#prim=and}}
...
CAMLprim int64_t caml_int64_{{prim}}_native(int64_t i1, int64_t i2)
{ return i1 & i2; }
CAMLprim value caml_int64_{{prim}}(value v)
{ return caml_copy_int64(caml_int64_{{prim}}_native(Int64_val(v1),
                                                    Int64_val(v2))); }
{{/prim=and}}
...
CAMLprim int64_t caml_int64_{{prim}}_native(int64_t dividend, int64_t divisor)
{
  if (divisor == 0) caml_raise_zero_divide();
  /* PR#4740: on some processors, division crashes on overflow.
     Implement the same behavior as for type "int". */
...
CAMLprim int64_t caml_int64_{{prim}}_native(int64_t)
{ return -i; }
CAMLprim value caml_int64_{{prim}}(value v)
{ return caml_copy_int64(caml_int64_{{prim}}_native(Int64_val(v))); }
{{/prim=neg}}

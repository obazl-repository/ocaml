...
extern value caml_ml_open_descriptor_in_with_flags();
extern value caml_ml_open_descriptor_out();
extern value caml_ml_open_descriptor_out_with_flags();
...
extern value caml_recommended_domain_count();
...
extern value caml_sys_is_regular_file();

## write shell script to run compiler and capture stdout/stderr
## then compare actual to expected outputs
...
def compile_test_impl(ctx, tc, exe_name, workdir):
    ...
    runner = ctx.actions.declare_file(workdir + "compile_test_test_runner.sh")

...
###################################
## the rule interface
user_toolchain_adapter = rule(
    _user_toolchain_adapter_impl,
    attrs = {
    ...
    doc = "Defines a toolchain for users.",
